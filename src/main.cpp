...
uint256 hashGenesisBlock("0xe7151d967c20da83b5dab06cec55c490569df3197465e843860210e340d837ea");
...
const string strMessageMagic = "LeproCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // LeproCoin: 0.35 days
static const int64 nTargetSpacing = 15; // LeproCoin: 15 seconds
...
{
        static const int64 BlocksTargetSpacing = .25 * 60; // 15 seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
        ...
        if (fTestNet) {
                ...
                if (pindexLast->nHeight+1 >= 190000) { DiffMode = 2; }
        }
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal leprocoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "LeproCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xab18d4c13f2265f32ec715ad816e4f327ec523ebcb4e9bfd19622fc1360bfb58");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        block.nVersion = 1;
        block.nTime    = 1387929815;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085439244;

        if (fTestNet)
        {
            block.nTime    = 1387844666;
            block.nNonce   = 386645701;
        }
